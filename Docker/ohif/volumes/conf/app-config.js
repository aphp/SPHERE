window.config = {
  ...
  servers: {
    dicomWeb: [
      {
        name: 'SPHERE',
        wadoUriRoot: 'http://localhost:8081/wadors',
        qidoRoot: 'http://localhost:8081/qidors',
        wadoRoot: 'http://localhost:8081/wadors',
  ...
  //     authority: 'https://keycloak.eds.aphp.fr/auth/realms/master/.well-known/openid-configuration',
